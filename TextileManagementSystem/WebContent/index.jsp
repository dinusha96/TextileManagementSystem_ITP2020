...
<jsp:include page="HomeHeader.jsp"></jsp:include>
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
  				<img src="images/slideshow_images/s1.jpg" style="width:100%; height:500px">
			</div>
	...
	<div class="row">
 			...
 			<h2><a href="#" class="category_headings">Men's Wear</a></h2>
  			</div>
 			...
 			<h2><a href="#" class="category_headings">Babies' Wear</a></h2>
  			</div>
  		</div>
  		...
  		<!-- second row of flip image -->
 			...
 			<h2><a href="#" class="category_headings">Women's Wear</a></h2>
  			</div>
